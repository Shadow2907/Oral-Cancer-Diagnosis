...
SELECT 
    m.id AS image_id,
    CAST(json_extract_scalar(json_parse(annotation), '$.properties.polygon_id') AS INTEGER) AS annotation_id,
    json_extract_scalar(json_parse(annotation), '$.geometry.type') AS annotation_type,
